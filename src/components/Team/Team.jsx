...
const Team = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-2xl lg:text-5xl capitalize">Group of Ventures</h1>
        <p className="2xl:text-lg">
          Welcome to Swiston International, a premier Dubai-based international
          business company that redefines the landscape of global imports &
          exports With a robust presence in multiple sectors including
          infrastructure development, petroleum, gold & diamond industry. We are
          your trusted partner in expanding horizons and unlocking opportunities
          worldwide.
        </p>
